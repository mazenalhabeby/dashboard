(this.webpackJsonpisomorphic = this.webpackJsonpisomorphic || []).push([
  [23],
  {
    ...
    973: function(e, t, n) {
              ...
              },
              {
                ...
                value: function() {
                  var e = this.props,
                    ...
                    u = r.a.Children.only(t);
                  if (!n && this.state.active) {
                    var p = u.props,
                      c = p.style,
                      h = p.className;
                    return (
                      !1 !== a && (a && (c = l()({}, c, a)), (h = i()(h, o))),
                      r.a.cloneElement(u, l()({ className: h, style: c }, s))
                    );
                  }
                  return r.a.cloneElement(u, s);
                },
              },
            ]),
            t
        ...
        return (
          ...
          (t.prototype.render = function() {
            var e = this.props,
              t = e.prefixCls,
              n = e.disabled,
              o = u()(e, ['prefixCls', 'disabled']);
            return r.a.createElement(
              E,
              { disabled: n, activeClassName: t + '-handler-active' },
              r.a.createElement('span', o)
            );
          }),
          t
        );
      ...
      var P = Number.MAX_SAFE_INTEGER || Math.pow(2, 53) - 1,
        T = function(e) {
        ...
        V = (function(e) {
          function t(n) {
            ...
            D.call(o);
            var r = void 0;
            (r = 'value' in n ? n.value : n.defaultValue),
              (o.state = { focused: n.autoFocus });
            var a = o.getValidValue(o.toNumber(r));
            return (
              (o.state = l()({}, o.state, {
                inputValue: o.toPrecisionAsStep(a),
                value: a,
              })),
              o
            );
          ...
          return (
            ...
            (t.prototype.componentDidUpdate = function(e) {
              ...
              if (e) {
                if (e.value !== n) {
                  var s = i ? n : this.getValidValue(n),
                    u = void 0;
                ...
                var p = 'value' in this.props ? n : this.state.value;
                'max' in this.props &&
                  e.max !== r &&
                  'number' === typeof p &&
                  p > r &&
            ...
            (t.prototype.setValue = function(e, t) {
              var n = this.props.precision,
                o = this.isNotCompleteNumber(parseFloat(e, 10))
                  ? null
                  : parseFloat(e, 10),
                r = this.state,
                a = r.value,
                ...
                s = r.inputValue,
                u = void 0 === s ? null : s,
                p = 'number' === typeof o ? o.toFixed(n) : '' + o,
                l = o !== i || p !== '' + u;
              return (
                'value' in this.props
                  ? this.setState(
                  ...
                  : this.setState(
                      { value: o, inputValue: this.toPrecisionAsStep(e) },
                      t
                    ),
                l && this.props.onChange(o),
                o
              );
            }),
            ...
            (t.prototype.step = function(e, t) {
              ...
              if (!a.disabled) {
                ...
                if (!this.isNotCompleteNumber(i)) {
                  var s = this[e + 'Step'](i, o),
                    u = s > a.max || s < a.min;
                  s > a.max ? (s = a.max) : s < a.min && (s = a.min),
                    this.setValue(s),
            ...
            (t.prototype.render = function() {
              ...
              if (m || 0 === m)
                if (isNaN(m))
                  (d = n + '-handler-up-disabled'),
                    (v = n + '-handler-down-disabled');
                else {
                  var y = Number(m);
                  y >= t.max && (d = n + '-handler-up-disabled'),
                    y <= t.min && (v = n + '-handler-down-disabled');
                }
              var b = {};
              for (var g in t)
                !t.hasOwnProperty(g) ||
                  ('data-' !== g.substr(0, 5) &&
                    ...
                    'role' !== g) ||
                  (b[g] = t[g]);
              var C = !t.readOnly && !t.disabled,
                w = this.getInputDisplayValue(),
                S = void 0,
                E = void 0;
              s
                ? ((S = {
                    onTouchStart: C && !d ? this.up : O,
                    onTouchEnd: this.stop,
                  }),
                  (E = {
                    onTouchStart: C && !v ? this.down : O,
                    onTouchEnd: this.stop,
                  }))
                : ((S = {
                    onMouseDown: C && !d ? this.up : O,
                    onMouseUp: this.stop,
                    onMouseLeave: this.stop,
                  }),
                  (E = {
                    onMouseDown: C && !v ? this.down : O,
                    onMouseUp: this.stop,
                    onMouseLeave: this.stop,
                  }));
              var N = !!d || o || a,
                  ...
                  r.a.createElement(
                    ...
                    l()(
                      ...
                      S,
                      {
                        ...
                        'aria-disabled': !!N,
                        className: n + '-handler ' + n + '-handler-up ' + d,
                      }
                    ),
                    c ||
                    ...
                    l()(
                      {
                        ...
                        onBlur: this.onBlur,
                        onKeyDown: C ? this.onKeyDown : O,
                        onKeyUp: C ? this.onKeyUp : O,
      ...
      var D = function() {
          ...
          (this.onKeyDown = function(t) {
            ...
            (this.onBlur = function(t) {
              ...
              if (a) {
                var u = e.input.value,
                  p = e.getInputDisplayValue({ focus: !1, value: s });
                (e.input.value = p),
            ...
            (this.getInputDisplayValue = function(t) {
              var n = t || e.state,
                ...
                a = n.value,
                i = void 0;
              (void 0 !== (i = o ? r : e.toPrecisionAsStep(a)) && null !== i) ||
                (i = '');
              var s = e.formatWrapper(i);
              return (
            ...
            (this.restoreByAfter = function(t) {
              ...
              return (
                -1 !== o &&
                (o + t.length === n.length && (e.fixCaret(o, o), !0))
              );
            }),
            ...
            return (
              ...
              (e.renderInputNumber = function(t) {
                var n,
                  ...
                  u = a.size,
                  p = a.prefixCls,
                  l = R(a, ['className', 'size', 'prefixCls']),
                  c = r('input-number', p),
                  h = i()(
                    (k((n = {}), ''.concat(c, '-lg'), 'large' === u),
                    k(n, ''.concat(c, '-sm'), 'small' === u),
                    n),
                    s
                  ),
                  f = o.createElement(F.a, {
                    type: 'up',
                    className: ''.concat(c, '-handler-up-inner'),
                  }),
                  d = o.createElement(F.a, {
                    type: 'down',
          ...
          return (
            ...
            (r = [
              ...
              },
              {
                key: 'render',
                value: function() {
                  return o.createElement(A.a, null, this.renderInputNumber);
                },
              },
            ]) && j(n.prototype, r),
            a && j(n, a),
...
//# sourceMappingURL=23.1a1c9158.chunk.js.map
