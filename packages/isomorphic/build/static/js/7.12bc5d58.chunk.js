    ...
    1805: function(t, e, n) {
      t.exports = (function(t) {
          ...
          n = (function(t, e) {
            ...
            for (var a in r)
              if (r.hasOwnProperty(a)) {
                ...
                delete r[a].channels,
                  delete r[a].labels,
                  Object.defineProperty(r[a], 'channels', { value: o }),
                  Object.defineProperty(r[a], 'labels', { value: s });
              }
            (r.rgb.hsl = function(t) {
              ...
              (r.rgb.cmyk = function(t) {
                ...
                return [
                  100 *
                    ((1 - n - (e = Math.min(1 - n, 1 - i, 1 - r))) / (1 - e) ||
                      0),
                  100 * ((1 - i - e) / (1 - e) || 0),
                  100 * ((1 - r - e) / (1 - e) || 0),
                  100 * e,
              ...
              (r.lab.lch = function(t) {
                var e,
                  ...
                  r = t[2];
                return (
                  (e = (360 * Math.atan2(r, i)) / 2 / Math.PI) < 0 &&
                    (e += 360),
        ...
        function i(t) {
          var e = (function() {
              for (
                var t = {}, e = Object.keys(n), i = e.length, r = 0;
                r < i;
                r++
              )
          ...
          for (e[t].distance = 0; i.length; )
            for (
              var r = i.pop(), a = Object.keys(n[r]), o = a.length, s = 0;
              s < o;
              s++
            ) {
              var l = a[s],
        ...
        function a(t, e) {
          for (
            var i = [e[t].parent, t], a = n[e[t].parent][t], o = e[t].parent;
            e[o].parent;

          )
            i.unshift(e[o].parent),
              (a = r(n[e[o].parent][o], a)),
              (o = e[o].parent);
        ...
        Object.keys(n).forEach(function(t) {
          ...
          var e = (function(t) {
            for (
              var e = i(t), n = {}, r = Object.keys(e), o = r.length, s = 0;
              s < o;
              s++
            ) {
              var l = r[s];
        ...
        var s = o,
          ...
          u = {
            ...
            getAlpha: function(t) {
              var e = c(t);
              return e ? e[3] : (e = d(t)) ? e[3] : (e = h(t)) ? e[3] : void 0;
            },
        ...
        ((y.prototype = {
          ...
          (y.prototype.setValues = function(t, e) {
            ...
            if (
              ((r.alpha = Math.max(0, Math.min(1, void 0 === l ? r.alpha : l))),
              'alpha' === t)
            )
              return !1;
            for (n = 0; n < t.length; n++)
              (i = Math.max(0, Math.min(o[t][n], r[t][n]))),
                (r[t][n] = Math.round(i));
            for (var c in a) c !== t && (r[c] = s[t][c](r[t]));
            return !0;
          }),
        ...
        var w = {
            ...
            _mergerIf: function(t, e, n) {
              if (k(t)) {
                var i = e[t],
                  r = n[t];
                w.isObject(i) && w.isObject(r)
                  ? w.mergeIf(i, r)
                  : e.hasOwnProperty(t) || (e[t] = w.clone(r));
              }
            },
            merge: function(t, e, n) {
              ...
              for (i = (n = n || {}).merger || w._merger, r = 0; r < u; ++r)
                if (((e = l[r]), w.isObject(e)))
                ...
                t.moveTo(e, l),
                  s < u && l < c
                    ...
                    ? (t.moveTo(s, n),
                      ...
                      t.arc(s, l, o, I, P + I))
                    : l < c
                    ? (t.arc(s, l, o, -P, 0), t.arc(s, c, o, 0, P))
                    : t.arc(s, l, o, -P, P),
                  t.closePath(),
                  t.moveTo(e, n);
              } else t.rect(e, n, i, r);
                ...
                switch ((t.beginPath(), e)) {
                  ...
                  case 'rectRounded':
                    (u = n - (c = 0.516 * n)),
                      (s = Math.cos(d + T) * u),
                      (l = Math.sin(d + T) * u),
                      t.arc(i - s, r - l, c, d - P, d - I),
                      t.arc(i + l, r - s, c, d - I, d),
                      t.arc(i + s, r + l, c, d, d + I),
                      t.arc(i - l, r + s, c, d + I, d + P),
                      t.closePath();
                    break;
                  case 'rect':
                    if (!a) {
        ...
        V.extend(et.prototype, {
          ...
          linkScales: function() {
            ...
            (null !== t.xAxisID && t.xAxisID in n && !i.xAxisID) ||
              (t.xAxisID = i.xAxisID || r.xAxes[0].id),
              (null !== t.yAxisID && t.yAxisID in n && !i.yAxisID) ||
                (t.yAxisID = i.yAxisID || r.yAxes[0].id);
          },
          getDataset: function() {
          ...
          _resolveDatasetElementOptions: function(t, e) {
            ...
            for (n = 0, i = d.length; n < i; ++n)
              (r = d[n]),
                (a = e ? 'hover' + r.charAt(0).toUpperCase() + r.slice(1) : r),
                (h[r] = J([u[a], l[a], c[a]], f));
            return h;
          },
          _resolveDataElementOptions: function(t, e) {
            ...
            if (((i = i || {}), V.isArray(h)))
              for (o = 0, s = h.length; o < s; ++o)
                f[(l = h[o])] = J([i[l], c[l], d[l]], g, e, p);
            else
              for (o = 0, s = (a = Object.keys(h)).length; o < s; ++o)
                f[(l = a[o])] = J([i[l], c[h[l]], c[l], d[l]], g, e, p);
          ...
          _setDatasetHoverStyle: function() {
            ...
            if (o) {
              for (
                a = o._model,
                  r = this._resolveDatasetElementOptions(o, !0),
                  t = 0,
        ...
        function rt(t, e) {
          var n = e.startAngle,
            ...
            s = e.y;
          t.beginPath(),
            t.arc(o, s, e.outerRadius, n - a, i + a),
            e.innerRadius > r
              ? ((a = r / e.innerRadius),
                t.arc(o, s, e.innerRadius - r, i + a, n - a, !0))
              : t.arc(o, s, r, i + Math.PI / 2, n - Math.PI / 2),
            t.closePath(),
            t.clip();
        }
        function at(t, e, n) {
              ...
              if (s.length) {
                ...
                for (
                  a.save(),
                    ...
                    a.setLineDash &&
                      a.setLineDash(r.borderDash || u.borderDash),
                    a.lineDashOffset = st(
                      r.borderDashOffset,
                      u.borderDashOffset
                    ),
                    a.lineJoin = r.borderJoinStyle || u.borderJoinStyle,
                    a.lineWidth = st(r.borderWidth, u.borderWidth),
                  ...
                  (n = s[t]._view),
                    (e = -1 === c ? V.previousItem(s, t) : s[c]),
                    n.skip ||
                      ((c !== t - 1 && !o) || -1 === c
                        ? a.moveTo(n.x, n.y)
                        : V.canvas.lineTo(a, e._view, n),
                      (c = t));
            ...
            draw: function(t) {
              ...
              e.skip ||
                ((void 0 === t || V.canvas._isPointInArea(e, t)) &&
                  ...
                  V.canvas.drawPoint(n, i, a, o, s, r)));
            },
          }),
        ...
        var yt = G.extend({
          ...
          Mt = ft,
          Ct = yt;
        (_t.Arc = kt), (_t.Line = wt), (_t.Point = Mt), (_t.Rectangle = Ct);
        ...
        function At(t, e, n) {
          var i,
            ...
            l = V.isNullOrUndef(a)
              ? (function(t, e) {
                  ...
                  for (r = 0, a = t.getTicks().length; r < a; ++r)
                    (i = t.getPixelForTick(r)),
                      (o = r > 0 ? Math.min(o, Math.abs(i - n)) : o),
                      (n = i);
                  return o;
                })(e.scale, e.pixels)
              : -1;
          return (
            V.isNullOrUndef(a)
              ? ((i = l * n.categoryPercentage), (r = n.barPercentage))
              : ((i = a * o), (r = 1)),
        ...
        var Dt = nt.extend({
            ...
            updateElement: function(t, e, n) {
              ...
              (t._xScale = i.getScaleForId(r.xAxisID)),
                ...
                V.isArray(a.data[e]) && (t._model.borderSkipped = null),
            ...
            calculateBarValuePixels: function(t, e, n) {
              ...
              if (v || (void 0 === v && void 0 !== b))
                for (i = 0; i < _ && (r = g[i]).index !== t; ++i)
                  r.stack === b &&
                    ((a =
                      void 0 === (u = d._parseValue(f[r.index].data[e])).start
                        ? u.end
                        : u.min >= 0 && u.max >= 0
                        ? u.max
                        : u.min),
                    ((p.min < 0 && a < 0) || (p.max >= 0 && a > 0)) &&
                      (x += a));
              return (
                (o = d.getPixelForValue(x)),
                (l = (s = d.getPixelForValue(x + y)) - o),
                void 0 !== m &&
                  Math.abs(l) < m &&
                  ((l = m),
                  (s = (y >= 0 && !h) || (y < 0 && h) ? o - m : o + m)),
            ...
            draw: function() {
              var t = this.chart,
                ...
                r = n.length,
                a = 0;
              for (V.canvas.clipArea(t.ctx, t.chartArea); a < r; ++a) {
          ...
          legendCallback: function(t) {
            ...
            if ((r.setAttribute('class', t.id + '-legend'), o.length))
              for (e = 0, n = o[0].data.length; e < n; ++e)
                ((i = r.appendChild(document.createElement('li'))).appendChild(
                ...
                return e.labels.length && e.datasets.length
                  ? e.labels.map(function(n, i) {
                      ...
                      return {
                        ...
                        hidden:
                          isNaN(e.datasets[0].data[i]) || r.data[i].hidden,
                        index: i,
                      };
                    })
                  : [];
        ...
        var Et = nt.extend({
          ...
          update: function(t) {
            ...
            for (i = 0, r = g.length; i < r; ++i)
              g[i]._options = a._resolveDataElementOptions(g[i], i);
            for (
          ...
          updateElement: function(t, e, n) {
            ...
            V.extend(t, {
              ...
              _model: {
                ...
                outerRadius: p,
                innerRadius: g,
                label: V.valueAtIndexOrDefault(h.label, e, r.data.labels[e]),
              },
            });
            var v = t._model;
            (n && s.animateRotate) ||
          ...
          getMaxBorderWidth: function(t) {
            ...
            for (e = 0, n = t.length; e < n; ++e)
              (r = t[e]),
                a
                  ? (a._configure(), (o = a._resolveDataElementOptions(r, e)))
                  : (o = r._options),
                'inner' !== o.borderAlign &&
                  ((s = o.borderWidth),
        ...
        var Ut = nt.extend({
            ...
            updateElement: function(t, e, n) {
              ...
              (i = d.getPixelForValue('object' === typeof c ? c : NaN, e, u)),
                (r = n ? h.getBasePixel() : a.calculatePointY(c, e, u)),
                (t._xScale = d),
                (t._yScale = h),
                (t._options = g),
                (t._datasetIndex = u),
            ...
            _resolveDatasetElementOptions: function(t) {
              ...
              return (
                (o.spanGaps = Bt(n.spanGaps, r.spanGaps)),
                (o.tension = Bt(n.lineTension, a.tension)),
                (o.steppedLine = Wt([i.steppedLine, n.steppedLine, a.stepped])),
                (o.clip = qt(
                  Bt(n.clip, Ht(e._xScale, e._yScale, o.borderWidth))
                )),
                o
              );
            },
            calculatePointY: function(t, e, n) {
              ...
              if (d.options.stacked) {
                for (
                  ...
                  (r = c.data.datasets[a.index]),
                    'line' === a.type &&
                      a.yAxisID === d.id &&
                      ((o = +d.getRightValue(r.data[e])) < 0
                        ? (f += o || 0)
                        : (h += o || 0));
                return s < 0
                  ? d.getPixelForValue(f + s)
                  : d.getPixelForValue(h + s);
              }
        ...
        var Kt = nt.extend({
          ...
          update: function(t) {
            ...
            for (e = 0, n = c.length; e < n; ++e)
              (c[e]._options = r._resolveDataElementOptions(c[e], e)),
        ...
        function ie(t, e, n) {
          ...
          n.axis = n.axis || 'x';
          var r = ne(n.axis),
            a = n.intersect ? te(t, i) : ee(t, i, !1, r),
            o = [];
          return a.length
        ...
        var re = {
            modes: {
              ...
              x: function(t, e, n) {
                ...
                return (
                  Qt(t, function(t) {
                    t.inXRange(i.x) && r.push(t),
                      t.inRange(i.x, i.y) && (a = !0);
                  }),
                  n.intersect && !a && (r = []),
                  r
                );
        ...
        function ue(t, e, n) {
          ...
          if (
            ...
            (r = e.outerHeight - le(o, t, 'top', 'bottom')),
            i !== t.w || r !== t.h)
          ) {
            (t.w = i), (t.h = r);
            ...
            update: function(t, e, n) {
              if (t) {
                var i = t.options.layout || {},
                  r = V.options.toPadding(i.padding),
                  a = e - r.width,
                  o = n - r.height,
                  s = (function(t) {
                    var e = (function(t) {
                  ...
                  d = ae(
                    { maxPadding: ae({}, r), w: a, h: o, x: r.left, y: r.top },
                    r
                  );
                !(function(t, e) {
                  var n, i, r;
                  for (n = 0, i = t.length; n < i; ++n)
                    ((r = t[n]).width = r.horizontal
                      ? r.box.fullWidth && e.availableWidth
                      : e.vBoxMaxWidth),
                      (r.height = r.horizontal && e.hBoxMaxHeight);
                })(l.concat(u), c),
                  de(l, d, c),
                  de(u, d, c) && de(l, d, c),
                  (function(t) {
                  ...
                  V.each(s.chartArea, function(e) {
                    var n = e.box;
                    ae(n, t.chartArea), n.update(d.w, d.h);
                  });
              }
            },
          },
        ...
        function Ae(t, e, n) {
          var i = t[me] || (t[me] = {}),
            r = (i.resizer = (function(t) {
              ...
              return (
                Me(n, 'scroll', r.bind(n, 'expand')),
                Me(i, 'scroll', r.bind(i, 'shrink')),
                e
              );
            })(
              (function(t, e) {
                ...
                if (i.resizer) {
                  var r = n.options.maintainAspectRatio && t.parentNode,
                    a = r ? r.clientWidth : 0;
                  e(Se('resize', n)),
                    r && r.clientWidth < a && n.canvas && e(Se('resize', n));
                }
              })
            ));
          !(function(t, e) {
        ...
        var Ie = {
          ...
          removeEventListener: function(t, e, n) {
            var i = t.canvas;
            if ('resize' !== e) {
              var r = ((n[me] || {}).proxies || {})[t.id + '_' + e];
              r && Ce(i, e, r);
            } else De(i);
          },
        };
        (V.addEvent = Me), (V.removeEvent = Ce);
        var Te = Ie._enabled
            ? Ie
            : {
                ...
                this._plugins.concat(r.plugins || []).forEach(function(t) {
                  if (-1 === n.indexOf(t)) {
                    var e = t.id,
                      r = a[e];
                    !1 !== r &&
                      (!0 === r && (r = V.clone(z.global.plugins[e])),
                      n.push(t),
          ...
          Le = {
            ...
            getScaleDefaults: function(t) {
              return this.defaults.hasOwnProperty(t)
                ? V.merge(Object.create(null), [z.scale, this.defaults[t]])
                : {};
            },
        ...
        var qe = G.extend({
            ...
            getTitle: function() {
              var t = this,
                ...
                o = [];
              return (o = Ne(o, Be(i))), (o = Ne(o, Be(r))), (o = Ne(o, Be(a)));
            },
            ...
            getBody: function(t, e) {
              ...
              return (
                V.each(t, function(t) {
                  ...
                  Ne(a.before, Be(i.beforeLabel.call(n, t, e))),
                    Ne(a.lines, i.label.call(n, t, e)),
                    Ne(a.after, Be(i.afterLabel.call(n, t, e))),
                    r.push(a);
                }),
                r
              );
            ...
            getFooter: function() {
              var t = this,
                ...
                a = [];
              return (a = Ne(a, Be(n))), (a = Ne(a, Be(i))), (a = Ne(a, Be(r)));
            },
            update: function(t) {
              var e,
                n,
              ...
              if (s.length) {
                ...
                var f = [],
                  g = [];
                h = Ee[r.position].call(i, s, i._eventPosition);
                var p = [];
                for (e = 0, n = s.length; e < n; ++e) p.push(We(s[e]));
                r.filter &&
                  ...
                  V.each(p, function(t) {
                    f.push(r.callbacks.labelColor.call(i, t, i._chart)),
                      g.push(r.callbacks.labelTextColor.call(i, t, i._chart));
                  }),
                  (o.title = i.getTitle(p, l)),
                  (o.beforeBody = i.getBeforeBody(p, l)),
                  (o.body = i.getBody(p, l)),
                  (o.afterBody = i.getAfterBody(p, l)),
                  (o.footer = i.getFooter(p, l)),
                  (o.x = h.x),
                  (o.y = h.y),
            ...
            drawTitle: function(t, e, n) {
              ...
              if (s) {
                ...
                for (
                  ...
                  n.fillText(o[a], l.x(t.x), t.y + i / 2),
                    (t.y += i + r),
                    a + 1 === s && (t.y += e.titleMarginBottom - r);
              }
            },
            drawBody: function(t, e, n) {
              ...
              (m = 0), V.each(e.afterBody, x), (t.y -= h);
            },
            drawFooter: function(t, e, n) {
              ...
              if (o) {
                ...
                for (
                  ...
                  n.fillText(a[r], s.x(t.x), t.y + i / 2),
            ...
            merger: function(t, e, n, i) {
              if ('xAxes' === t || 'yAxes' === t) {
                ...
                for (e[t] || (e[t] = []), r = 0; r < s; ++r)
                  (o = n[t][r]),
                    (a = Ke(o.type, 'xAxes' === t ? 'category' : 'linear')),
                    r >= e[t].length && e[t].push({}),
                    !e[t][r].type || (o.type && o.type !== e[t][r].type)
                      ? V.merge(e[t][r], [Le.getScaleDefaults(a), o])
                      : V.merge(e[t][r], o);
          ...
          return V.merge(Object.create(null), [].slice.call(arguments), {
            merger: function(t, e, n, i) {
              ...
              'scales' === t
                ? (e[t] = Ge(r, a))
                : 'scale' === t
                ? (e[t] = V.merge(r, [Le.getScaleDefaults(a.type), a]))
                : V._merger(t, e, n, i);
            },
          });
        }
        ...
        V.extend(tn.prototype, {
          ...
          resize: function(t) {
            var e = this,
              ...
              a = Math.max(0, Math.floor(V.getMaximumWidth(i))),
              o = Math.max(0, Math.floor(r ? a / r : V.getMaximumHeight(i)));
            if (
            ...
            e.scales &&
              ...
              V.each(i, function(e) {
                ...
                if (a in n && n[a].type === o)
                  ...
                  var l = Le.getScaleConstructor(o);
                  if (!l) return;
                  (s = new l({
                    id: a,
                    type: o,
          ...
          updateLayout: function() {
            ...
            !1 !== Fe.notify(t, 'beforeLayout') &&
              ...
              Fe.notify(t, 'afterScaleUpdate'),
              Fe.notify(t, 'afterLayout'));
          },
          updateDatasets: function() {
            if (!1 !== Fe.notify(this, 'beforeDatasetsUpdate')) {
              for (var t = 0, e = this.data.datasets.length; t < e; ++t)
                this.updateDataset(t);
              Fe.notify(this, 'afterDatasetsUpdate');
            }
          },
          updateDataset: function(t) {
            var e = this.getDatasetMeta(t),
              n = { meta: e, index: t };
            !1 !== Fe.notify(this, 'beforeDatasetUpdate', [n]) &&
              (e.controller._update(),
              Fe.notify(this, 'afterDatasetUpdate', [n]));
          },
          render: function(t) {
            var e = this;
            (t && 'object' === typeof t) ||
            ...
            var n = e.options.animation,
              i = Ke(t.duration, n && n.duration),
              r = t.lazy;
            if (!1 !== Fe.notify(e, 'beforeRender')) {
              var a = function(t) {
                Fe.notify(e, 'afterRender'),
          ...
          drawDatasets: function(t) {
            var e, n;
            if (!1 !== Fe.notify(this, 'beforeDatasetsDraw', [t])) {
              for (
              ...
              Fe.notify(this, 'afterDatasetsDraw', [t]);
            }
          },
          drawDataset: function(t, e) {
            var n = { meta: t, index: t.index, easingValue: e };
            !1 !== Fe.notify(this, 'beforeDatasetDraw', [n]) &&
              (t.controller.draw(e), Fe.notify(this, 'afterDatasetDraw', [n]));
          },
          _drawTooltip: function(t) {
            var e = this.tooltip,
              n = { tooltip: e, easingValue: t };
            !1 !== Fe.notify(this, 'beforeTooltipDraw', [n]) &&
              (e.draw(), Fe.notify(this, 'afterTooltipDraw', [n]));
          },
              ...
              if (sn(s))
                for (a = 0, o = s.length; a < o; ++a)
                  (g = s[a]),
                    ln(g) ||
                      sn(g) ||
                      ((h = V.measureText(t, c.data, c.gc, h, g)), (f += d));
        ...
        function vn(t) {
          var e,
            ...
            r = [];
          for (n = 0, i = t.length; n < i; ++n)
            'undefined' !== typeof (e = t[n])._index && r.push(e);
          return r;
        }
        function bn(t, e, n, i) {
          var r,
            ...
            c = 0;
          for (
            e = Math.ceil(e), i && (e = (r = i - n) / Math.floor(r / e)), s = l;
            s < 0;
        ...
        var xn = G.extend({
            ...
            return (
              ...
              (a = l._convertTicksToLabels(
                s
                  ? (function(t, e) {
                      for (
                        var n = [], i = t.length / e, r = 0, a = t.length;
                        r < a;
                        r += i
                      )
          ...
          calculateTickRotation: function() {
            ...
            !s.isHorizontal()
              ...
              : ((e = (t = s._getLabelSizes()).widest.width),
                ...
                e + 6 > (r = l.offset ? s.maxWidth / c : i / (c - 1)) &&
                  ((r = i / (c - (l.offset ? 0.5 : 1))),
                  (a =
                    s.maxHeight -
                    fn(l.gridLines) -
                    u.padding -
                  ...
                  (f = V.toDegrees(
                    Math.min(
                      Math.asin(Math.min((t.highest.height + 6) / r, 1)),
          ...
          fit: function() {
            var t = this,
              ...
              u = t.isHorizontal();
            if (
              (u ? (e.width = t.maxWidth) : s && (e.width = fn(o) + gn(a)),
              u ? s && (e.height = fn(o) + gn(a)) : (e.height = t.maxHeight),
              r.display && s)
            ) {
              var c = mn(r),
                d = t._getLabelSizes(),
          ...
          _convertTicksToLabels: function(t) {
            var e,
              ...
              r = this;
            for (
              r.ticks = t.map(function(t) {
                return t.value;
              }),
                r.beforeTickToLabelConversion(),
                e = r.convertTicksToLabels(t) || r.ticks,
          ...
          _autoSkip: function(t) {
            ...
            if (
              ((i = (function(t, e, n, i) {
                ...
                for (
                  o = 0, s = (r = V.math._factorize(l)).length - 1;
                  o < s;
                  o++
                )
                  if ((a = r[o]) > u) return a;
              ...
              return (
                (r = u > 1 ? (d - c) / (u - 1) : null),
                bn(t, i, V.isNullOrUndef(r) ? 0 : c - r, c),
                bn(t, i, d, V.isNullOrUndef(r) ? t.length : d + r),
                vn(t)
              );
            }
            return bn(t, i), vn(t);
            ...
            for (
              ...
              (i = C[n] || {}),
                (ln(i.label) && n < C.length) ||
                  ...
                  void 0 !== (r = dn(b, i._index || n, w)) &&
                    ((a = T(x, r, g)),
                    M ? (o = l = c = h = a) : (s = u = d = f = a),
                    A.push({
                      tx1: o,
                      ty1: s,
                      tx2: l,
          ...
          _computeLabelItems: function() {
            var t,
              ...
              y = g.padding,
              _ = fn(f.gridLines),
              k = -V.toRadians(h.labelRotation),
              w = [];
            for (
              'top' === p
                ? ((a = h.bottom - _ - y), (o = k ? 'left' : 'center'))
                : 'bottom' === p
                ? ((a = h.top + _ + y), (o = k ? 'right' : 'center'))
                : 'left' === p
                ? ((r = h.right - (m ? 0 : _) - y), (o = m ? 'left' : 'right'))
                : ((r = h.left + (m ? 0 : _) + y), (o = m ? 'right' : 'left')),
                t = 0,
                e = b.length;
              t < e;
              ++t
              ...
              (i = (n = b[t]).label),
                ln(i) ||
                  ((s = h.getPixelForTick(n._index || t) + g.labelOffset),
          ...
          _drawTitle: function() {
            ...
            if (i.display) {
              var r,
                a,
                o = un(i.fontColor, z.global.defaultFontColor),
              ...
              if (t.isHorizontal())
                ...
                var h = 'left' === c;
                (r = h ? t.left + u + l.top : t.right - u - l.top),
                  (a = t.top + t.height / 2),
          ...
          Sn = yn.extend({
              ...
              var t = this,
                ...
                r = (t.ticks = (function(t, e) {
                  ...
                  (a = Math.ceil(g / p) - Math.floor(f / p)) > u &&
                    ...
                    (r = Math.ceil(g / p) * p),
                    s &&
                      (!Cn(c) && V.almostWhole(c / p, p / 1e3) && (i = c),
                      !Cn(d) && V.almostWhole(d / p, p / 1e3) && (r = d)),
                    (a = (r - i) / p),
                    (a = V.almostEquals(a, Math.round(a), p / 1e3)
                      ? Math.round(a)
                      : Math.ceil(a)),
                    (i = Math.round(i * n) / n),
                    (r = Math.round(r * n) / n),
            ...
            _configure: function() {
              ...
              yn.prototype._configure.call(e),
                e.options.offset &&
                  n.length &&
                  ((i -= t = (r - i) / Math.max(n.length - 1, 1) / 2),
                  (r += t)),
                (e._startValue = i),
                (e._endValue = r),
                (e._valueRange = r - i);
            ...
            determineDataLimits: function() {
              ...
              for (t = 0; t < c; ++t)
                (n = o[(e = s[t]).index].data),
                  l ? An(r, u, e, n) : Dn(r, e, n);
              V.each(u, function(t) {
                (i = t.pos.concat(t.neg)),
                  (r.min = Math.min(r.min, V.min(i))),
                  (r.max = Math.max(r.max, V.max(i)));
              }),
                (r.min = V.isFinite(r.min) && !isNaN(r.min) ? r.min : 0),
                (r.max = V.isFinite(r.max) && !isNaN(r.max) ? r.max : 1),
        ...
        var zn = yn.extend({
            determineDataLimits: function() {
              ...
              if (s.stacked || h) {
                ...
                for (t = 0; t < u.length; t++)
                  if (
                    ((e = l.getDatasetMeta(t)), l.isDatasetVisible(t) && d(e))
                  )
              ...
              var t = this,
                ...
                r = (t.ticks = (function(t, e) {
                  var n,
                    i,
                    r = [],
                    a = On(t.min, Math.pow(10, Math.floor(Fn(e.min)))),
            ...
            _configure: function() {
              ...
              yn.prototype._configure.call(t),
                0 === e &&
                  ...
                  (n =
                    On(t.options.ticks.fontSize, z.global.defaultFontSize) /
                    t._length)),
                (t._startValue = Fn(e)),
                (t._valueOffset = n),
        ...
        var Gn = Sn.extend({
            ...
            determineDataLimits: function() {
              ...
              V.each(e.data.datasets, function(r, a) {
                if (e.isDatasetVisible(a)) {
                  var o = e.getDatasetMeta(a);
                  V.each(r.data, function(e, r) {
              ...
              t.display && t.pointLabels.display
                ? (function(t) {
                    var e,
                      n,
                      i,
                      r = V.options._parseFont(t.options.pointLabels),
                      a = {
                        l: 0,
                        r: t.width,
                        t: 0,
                    ...
                    for (e = 0; e < c; e++) {
                      ...
                      var d = t.getIndexAngle(e),
                        h = V.toDegrees(d) % 360,
                        f = Hn(h, i.x, n.w, 0, 180),
                        g = Hn(h, i.y, n.h, 90, 270);
                      f.start < a.l && ((a.l = f.start), (o.l = d)),
                        f.end > a.r && ((a.r = f.end), (o.r = d)),
                        g.start < a.t && ((a.t = g.start), (o.t = d)),
                        g.end > a.b && ((a.b = g.end), (o.b = d));
                    }
              ...
              if (
                  ...
                  (function(t) {
                    ...
                    for (var s = t.chart.data.labels.length - 1; s >= 0; s--) {
                      var l = 0 === s ? r / 2 : 0,
                        ...
                        c = Bn(i.fontColor, s, z.global.defaultFontColor);
                      e.fillStyle = c;
                      var d = t.getIndexAngle(s),
                        h = V.toDegrees(d);
                      (e.textAlign = qn(h)),
                        Yn(h, t._pointLabelSizes[s], u),
                ...
                for (
                  r.save(),
                    ...
                    r.strokeStyle = u,
                    r.setLineDash &&
                      (r.setLineDash(Wn([s.borderDash, o.borderDash, []])),
                      (r.lineDashOffset = Wn([
                        s.borderDashOffset,
                        o.borderDashOffset,
                        0,
            ...
            _drawLabels: function() {
              ...
              if (n.display) {
                ...
                e.save(),
                  ...
                  (e.textAlign = 'center'),
                  (e.textBaseline = 'middle'),
                  V.each(t.ticks, function(a, l) {
                    (0 !== l || n.reverse) &&
                      ((i = t.getDistanceFromCenterForValue(
                        t.ticksAsNumbers[l]
                      )),
                      n.showLabelBackdrop &&
                        ((r = e.measureText(a).width),
        ...
        function si(t, e) {
          ...
          return (
            ...
            null !== o
              ...
              : (r ||
                  'function' !== typeof a ||
                  ((o = a(e)), V.isFinite(o) || (o = n.parse(o))),
                o)
          );
        }
        function li(t, e) {
        ...
        function ui(t, e, n, i) {
          var r,
            ...
            o,
            s = ni.length;
          for (r = ni.indexOf(t); r < s - 1; ++r)
            if (
              ((o = (a = ei[ni[r]]).steps ? a.steps : ti),
        ...
        function ci(t, e, n) {
          var i,
            ...
            s = e.length;
          for (i = 0; i < s; ++i)
            (o[(r = e[i])] = i), a.push({ value: r, major: !1 });
          return 0 !== s && n
            ? (function(t, e, n, i) {
                var r,
                  a,
        ...
        var di = yn.extend({
            ...
            determineDataLimits: function() {
              ...
              for (t = 0, n = (l.data.datasets || []).length; t < n; ++t)
                if (l.isDatasetVisible(t))
                  if (((r = l.data.datasets[t].data), V.isObject(r[0])))
                    for (p[t] = [], e = 0, i = r.length; e < i; ++e)
                      (a = li(s, r[e])), g.push(a), (p[t][e] = a);
            ...
            buildTicks: function() {
                    ...
                    : (function(t, e, n, i) {
                        ...
                        if (
                          ...
                          throw e +
                            ...
                            ' ' +
                            l;
                        for (r = d; r < n; r = +a.add(r, u, l)) h.push(r);
                        return (
                          (r !== n && 'ticks' !== o.bounds) || h.push(r), h
                        );
                      })(i, r, a, d),
                  'ticks' === o.bounds &&
                    u.length &&
                    ((r = u[0]), (a = u[u.length - 1])),
                  r = li(i, ri(o)) || r,
                  a = li(i, ai(o)) || a,
                  t = 0,
                  e = u.length;
              ...
              return (
                ...
                (i._unit =
                  l.unit ||
                  (s.autoSkip
                    ? ui(l.minUnit, i.min, i.max, d)
                    : (function(t, e, n, i, r) {
                        var a, o;
                        for (a = ni.length - 1; a >= ni.indexOf(n); a--)
                          if (
                            ((o = ni[a]),
                            ei[o].common && t._adapter.diff(r, i, o) >= e - 1)
                          )
                            return o;
                        return ni[n ? ni.indexOf(n) : 0];
                      })(i, c.length, l.minUnit, i.min, i.max))),
                (i._majorUnit =
            ...
            getLabelForIndex: function(t, e) {
              ...
              return (
                ...
                a.tooltipFormat
                  ? i.format(si(n, o), a.tooltipFormat)
                  : 'string' === typeof o
                  ? o
                  : i.format(si(n, o), a.displayFormats.datetime)
              );
            },
            ...
            _getLabelSize: function(t) {
              var e = this.options.ticks,
                ...
                r = Math.cos(i),
                a = Math.sin(i),
                o = Jn(e.fontSize, z.global.defaultFontSize);
            ...
            getLabelCapacity: function(t) {
              var e = this,
                ...
                a = e.tickFormatFunction(t, 0, ci(e, [t], e._majorUnit), r),
                o = e._getLabelSize(a),
                s = Math.floor(
          ...
          return (t.el._scale || {}).getPointPositionForValue
            ? (function(t) {
                ...
                for (
                  ...
                  (a =
                    'start' === u || 'end' === u
                      ? o.getPointPositionForValue(r, 'start' === u ? e : n)
                      : o.getBasePosition(r)),
                    s.gridLines.circular &&
                      ((a.cx = i.x),
                      (a.cy = i.y),
                      (a.angle = o.getIndexAngle(r) - Math.PI / 2)),
                    c.push(a);
                return c;
              })(t)
            : (function(t) {
        ...
        function _i(t, e, n, i, r) {
          ...
          if (i && r) {
            for (t.moveTo(e[0].x, e[0].y), a = 1; a < i; ++a)
              V.canvas.lineTo(t, e[a - 1], e[a]);
            if (void 0 === n[0].angle)
              for (t.lineTo(n[r - 1].x, n[r - 1].y), a = r - 1; a > 0; --a)
                V.canvas.lineTo(t, n[a], n[a - 1], !0);
            else
              for (
                o = n[0].cx,
                  s = n[0].cy,
        ...
        function ki(t, e, n, i, r, a) {
          ...
          _i(t, m, v, b, x), t.closePath(), (t.fillStyle = r), t.fill();
        }
        var wi = {
            id: 'filler',
            ...
            beforeDatasetsDraw: function(t) {
              ...
              for (n = l.length - 1; n >= 0; --n)
                (e = l[n].$filler) &&
                  ...
                  (a = i._children || []),
                  (o = e.mapper),
                  (s = r.backgroundColor || z.global.defaultColor),
                  o &&
                    s &&
                    a.length &&
                    (V.canvas.clipArea(u, t.chartArea),
                    ki(u, a, o, r, s, i._loop),
                    V.canvas.unclipArea(u)));
            },
          },
          Mi = V.rtl.getRtlAdapter,
          Ci = V.noop,
          Si = V.valueOrDefault;
        function Pi(t, e) {
        ...
        z._set('global', {
          ...
          legendCallback: function(t) {
            var e,
              ...
              a = t.data.datasets;
            for (
              r.setAttribute('class', t.id + '-legend'), e = 0, n = a.length;
              e < n;
              e++
            )
              ((i = r.appendChild(document.createElement('li'))).appendChild(
        ...
        var Ai = G.extend({
              ...
              if (((r.font = a.string), u)) {
                ...
                (r.textAlign = 'left'),
                  ...
                  V.each(t.legendItems, function(t, e) {
                    ...
                    (0 === e ||
                      c[c.length - 1] + i + 2 * n.padding > l.width) &&
                      ((d += o + n.padding),
          ...
          draw: function() {
            ...
            if (e.display) {
              var c,
                d = Mi(e.rtl, t.left, t.minSize.width),
                h = t.ctx,
              ...
              V.each(t.legendItems, function(e, i) {
                ...
                !(function(t, e, i) {
                  if (!(isNaN(m) || m <= 0)) {
                    h.save();
                    var o = Si(i.lineWidth, a.borderWidth);
                    if (
                      ((h.fillStyle = Si(i.fillStyle, r)),
                      (h.lineCap = Si(i.lineCap, a.borderCapStyle)),
                      (h.lineDashOffset = Si(
                        i.lineDashOffset,
                        a.borderDashOffset
                      )),
                      (h.lineJoin = Si(i.lineJoin, a.borderJoinStyle)),
                      (h.lineWidth = o),
                      (h.strokeStyle = Si(i.strokeStyle, r)),
                      h.setLineDash &&
                        h.setLineDash(Si(i.lineDash, a.borderDash)),
                      n && n.usePointStyle)
                    ) {
                      var s = (m * Math.SQRT2) / 2,
                        l = d.xPlus(t, m / 2),
                        u = e + p / 2;
                      V.canvas.drawPoint(h, i.pointStyle, s, l, u, i.rotation);
                    } else
                  ...
                  (v[i].left = d.leftForLtr(w, v[i].width)),
                  (v[i].top = k),
                  (function(t, e, n, i) {
                    var r = p / 2,
                      a = d.xPlus(t, m + r),
            ...
            beforeUpdate: function(t) {
              ...
              e
                ? (V.mergeIf(e, z.global.legend),
                  n ? (ge.configure(t, n, e), (n.options = e)) : Di(t, e))
          ...
          fit: function() {
            ...
            n.display
              ? ((t =
                  ...
                  2 * n.padding),
                (e.width = i.width = r ? e.maxWidth : t),
        ...
        (function() {
          ...
          (V.where = function(t, e) {
            ...
            (V.getRelativePosition = function(t, e) {
              ...
              var l = parseFloat(V.getStyle(a, 'padding-left')),
                u = parseFloat(V.getStyle(a, 'padding-top')),
                c = parseFloat(V.getStyle(a, 'padding-right')),
                d = parseFloat(V.getStyle(a, 'padding-bottom')),
            ...
            (V.longestText = function(t, e, n, i) {
              ...
              var o,
                ...
                h = n.length;
              for (o = 0; o < h; o++)
                if (void 0 !== (u = n[o]) && null !== u && !0 !== V.isArray(u))
                  d = V.measureText(t, r, a, d, u);
                else if (V.isArray(u))
                  for (s = 0, l = u.length; s < l; s++)
                    void 0 === (c = u[s]) ||
                      null === c ||
                      V.isArray(c) ||
                      (d = V.measureText(t, r, a, d, c));
              var f = a.length / 2;
              if (f > n.length) {
            ...
            (V.measureText = function(t, e, n, i, r) {
              var a = e[r];
              return (
        ...
        Li))
          Li.hasOwnProperty(Ni) && en.plugins.register(Li[Ni]);
    ...
    610: function(t, e, n) {
      ...
      t.exports = function(t, e, n, l, u, c) {
        ...
        for (c.set(t, e), c.set(e, t); ++p < h; ) {
          var b = t[p],
            x = e[p];
          if (l) var y = d ? l(x, b, p, e, t, c) : l(b, x, p, t, e, c);
          if (void 0 !== y) {
            if (y) continue;
            m = !1;
            break;
          ...
          if (v) {
            if (
              !r(e, function(t, e) {
                if (!a(v, e) && (b === t || u(b, t, n, l, c))) return v.push(e);
              })
            ) {
              m = !1;
              break;
            }
          } else if (b !== x && !u(b, x, n, l, c)) {
            m = !1;
            break;
          }
        }
      ...
      t.exports = function(t, e, n, s) {
        ...
        for (; ++l < u; ) {
          ...
          if (c && d[2]) {
            ...
            var p = new i();
            if (s) var m = s(f, g, h, t, e, p);
            if (!(void 0 === m ? r(g, f, a | o, s, p) : m)) return !1;
          }
        }
        return !0;
      };
    ...
    700: function(t, e, n) {
      ...
      t.exports = function(t, e, n, m, v, b) {
        ...
        if (C && !w)
          return (
            b || (b = new i()),
            x || c(t) ? r(t, e, n, m, v, b) : a(t, e, _, n, m, v, b)
          );
        if (!(n & d)) {
          var S = w && p.call(t, '__wrapped__'),
            P = M && p.call(e, '__wrapped__');
          if (S || P) {
            var A = S ? t.value() : t,
              D = P ? e.value() : e;
            return b || (b = new i()), v(A, D, n, m, b);
          }
        }
        return !!C && (b || (b = new i()), o(t, e, n, m, v, b));
      };
    },
    701: function(t, e, n) {
      var i = n(99),
      ...
      t.exports = function(t, e, n, i, k, M, C) {
        switch (n) {
          case _:
    ...
    702: function(t, e, n) {
      ...
      t.exports = function(t, e, n, o, s, l) {
        ...
        for (var m = u; ++h < d; ) {
          var v = t[(f = c[h])],
            b = e[f];
          if (o) var x = u ? o(b, v, f, e, t, l) : o(v, b, f, t, e, l);
          if (!(void 0 === x ? v === b || s(v, b, n, o, l) : x)) {
            p = !1;
            break;
          }
          m || (m = 'constructor' == f);
      ...
      (function(t) {
        ...
        (x.getLabelAsKey = function(t) {
          ...
          (x.defaultProps = {
            ...
            redraw: !1,
            options: {},
            datasetKeyProvider: x.getLabelAsKey,
          });
        var y = (function(t) {
            function e() {
...
//# sourceMappingURL=7.12bc5d58.chunk.js.map
