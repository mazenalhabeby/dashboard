  ...
  [80],
  {
    2064: function(e, t, i) {
        ...
        h = function(e) {
          ...
          var L = function() {
              ...
              var e = 0,
                i = k ? 1 : 0;
              return (
                r.Children.forEach(a, function(s) {
                  r.isValidElement(s) && (s.key === t && (e = i), (i += 1));
                }),
                e
              );
            },
            ...
            O = function() {
              null !== $.current &&
                ($.current.destroy(!0, !0), ($.current = null), I($.current));
            },
            D = function() {
              z.current &&
                null === $.current &&
                (($.current = new o.default(z.current, l.default({}, e))),
                I($.current));
            };
          return (
            r.useEffect(function() {
              ...
              var e = L();
              return (
                null !== $.current && null !== e && $.current.slideTo(e),
                function() {
                  return O();
                }
              );
            ...
            r.useEffect(function() {
              if (null !== $.current) {
                if (b) O(), D();
                  ...
                  null !== $.current && ($.current.update(), I($.current));
            ...
            r.default.createElement(
              i,
              { className: n, dir: C && 'rtl', ref: z },
              f && v && T && T(e),
              r.default.createElement(
                m,
                { className: g },
                r.Children.map(a, function(e) {
                  if (!d.isReactElement(e)) return null;
                  var t = [P, e.props.className];
                  return (
                    p && t.push('swiper-no-swiping'),
                    r.cloneElement(
                      e,
                      s({}, e.props, { className: t.join(' ').trim() })
                    )
                  );
                })
              ),
      ...
      (h.defaultProps = {
        ...
        renderScrollbar: function(e) {
          var t = e.scrollbar;
          return t
            ? r.default.createElement('div', { className: d.classNames(t.el) })
            : null;
        },
    ...
    2617: function(e, t, i) {
          ...
          if ('string' === typeof e) {
            ...
            if (r.indexOf('<') >= 0 && r.indexOf('>') >= 0) {
              ...
              for (
                a =
                  t || '#' !== e[0] || e.match(/[ .<>:~]/)
                    ? (t || h).querySelectorAll(e.trim())
                    : [h.getElementById(e.trim().split('#')[1])],
                  s = 0;
                s < a.length;
                s += 1
              )
                a[s] && i.push(a[s]);
          } else if (e.nodeType || e === c || e === h) i.push(e);
      ...
      var v = {
            ...
            if (a)
              ...
              for (d = 0; d < h.length; d += 1) {
                ...
                p.dom7Listeners || (p.dom7Listeners = {}),
                  ...
                  p.dom7Listeners[v].push({ listener: n, proxyListener: l }),
          ...
          for (var o = s.split(' '), l = 0; l < o.length; l += 1)
            for (var d = o[l], h = 0; h < this.length; h += 1) {
              ...
              if (
                (!a && c.dom7Listeners
                  ? (p = c.dom7Listeners[d])
                  : a && c.dom7LiveListeners && (p = c.dom7LiveListeners[d]),
                p && p.length)
              )
                for (var u = p.length - 1; u >= 0; u -= 1) {
                  var f = p[u];
                  n && f.listener === n
                    ? (c.removeEventListener(d, f.proxyListener, r),
                      p.splice(u, 1))
                    : n &&
                      f.listener &&
        ...
        add: function() {
          for (
            var e, t, i = arguments.length, s = new Array(i), a = 0;
            a < i;
            a++
          )
            s[a] = arguments[a];
          for (e = 0; e < s.length; e += 1) {
            ...
            for (t = 0; t < n.length; t += 1)
              (this[this.length] = n[t]), (this.length += 1);
          }
          return this;
        },
        styles: function() {
              ...
              c.WebKitCSSMatrix
                ? ((i = n.transform || n.webkitTransform).split(',').length >
                    ...
                    (i = i
                      ...
                      .join(', ')),
                  (s = new c.WebKitCSSMatrix('none' === i ? '' : i)))
                : (t = (s =
                    n.MozTransform ||
                    n.OTransform ||
                    n.MsTransform ||
            ...
            for (
              ...
              if (void 0 !== i && null !== i)
                for (
                  ...
                  void 0 !== o &&
                    o.enumerable &&
                    (m.isObject(e[r]) && m.isObject(i[r])
                      ? m.extend(e[r], i[r])
                      : !m.isObject(e[r]) && m.isObject(i[r])
                      ? ((e[r] = {}), m.extend(e[r], i[r]))
                      : (e[r] = i[r]));
                }
            }
            return e;
        ...
        g = {
          touch:
            ...
            !!(
              ...
              'ontouchstart' in c ||
              (c.DocumentTouch && h instanceof c.DocumentTouch)
            ),
          pointerEvents:
            !!c.PointerEvent &&
      ...
      var y = {
          ...
          if ('undefined' !== typeof i) {
            ...
            for (
              var S,
                M = e.slidesPerColumn,
                P = T / M,
                k = Math.floor(l / e.slidesPerColumn),
                z = 0;
              z < l;
              z += 1
            ) {
              ...
              if (e.slidesPerColumn > 1) {
                ...
                if ('row' === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
                  var D = Math.floor(
                      z / (e.slidesPerGroup * e.slidesPerColumn)
                    ),
                    A = z - e.slidesPerColumn * e.slidesPerGroup * D;
                  (L =
                    (I =
                      A -
                      (O = Math.floor(A / e.slidesPerGroup)) *
                        e.slidesPerGroup +
                      D * e.slidesPerGroup) +
                    (O * T) / M),
                    $.css({
                ...
                $.css(
                  ...
                  0 !== O && e.spaceBetween && ''.concat(e.spaceBetween, 'px')
                );
              }
              if ('none' !== $.css('display')) {
                if ('auto' === e.slidesPerView) {
                  var N = c.getComputedStyle($[0], null),
                    H = $[0].style.transform,
                  ...
                  if (
                    ...
                    var B = parseFloat(N.getPropertyValue('width')),
                      ...
                      F = parseFloat(N.getPropertyValue('margin-right')),
                      R = N.getPropertyValue('box-sizing');
                    C = R && 'border-box' === R ? B + Y + F : B + V + X + Y + F;
                  } else {
                    var j = parseFloat(N.getPropertyValue('height')),
                    ...
                    C = U && 'border-box' === U ? j + _ + K : j + q + W + _ + K;
                  }
                  ...
                  (C = (i - (e.slidesPerView - 1) * y) / e.slidesPerView),
                    ...
                    o[z] &&
                      (this.isHorizontal()
                        ? (o[z].style.width = ''.concat(C, 'px'))
                        : (o[z].style.height = ''.concat(C, 'px')));
                o[z] && (o[z].swiperSlideSize = C),
                  p.push(C),
                  e.centeredSlides
                    ? ((w = w + C / 2 + x / 2 + y),
                      0 === x && 0 !== z && (w = w - i / 2 - y),
            ...
            if (
              ...
              for (var J = 0; J < d.length; J += 1) {
                ...
                e.roundLengths && (Z = Math.floor(Z)),
                  d[J] < this.virtualSize + d[0] && S.push(Z);
              }
              d = S;
            }
            if (!e.centeredSlides) {
              ...
              for (var Q = 0; Q < d.length; Q += 1) {
                ...
                e.roundLengths && (ee = Math.floor(ee)),
                  d[Q] <= this.virtualSize - i && S.push(ee);
              }
              (d = S),
            ...
            if (
              ...
              0 !== e.spaceBetween &&
                (this.isHorizontal()
                  ? s
                    ? o.filter(u).css({ marginLeft: ''.concat(y, 'px') })
                    : o.filter(u).css({ marginRight: ''.concat(y, 'px') })
                  : o.filter(u).css({ marginBottom: ''.concat(y, 'px') })),
        ...
        updateProgress: function(e) {
          ...
          0 === s
            ...
            m.extend(this, { progress: a, isBeginning: n, isEnd: r }),
      ...
      var E = {
        slideTo: function() {
          ...
          if (r.cssMode) {
            var b,
              y = a.isHorizontal();
            if (0 === t) u[y ? 'scrollLeft' : 'scrollTop'] = -m;
            else if (u.scrollTo)
              u.scrollTo(
                ((b = {}),
                Object(o.a)(b, y ? 'left' : 'top', -m),
                Object(o.a)(b, 'behavior', 'smooth'),
                b)
              );
            else u[y ? 'scrollLeft' : 'scrollTop'] = -m;
            return !0;
          }
          return (
            0 === t
        ...
        loopCreate: function() {
          ...
          if (t.loopFillGroupWithBlank) {
            ...
            if (a !== t.slidesPerGroup) {
              for (var n = 0; n < a; n += 1) {
                var r = u(h.createElement('div')).addClass(
              ...
              if (!l || !(r <= d || r >= c.screen.width - d)) {
                if (
                  ...
                  n.is(t.formElements) && (p = !1),
                    h.activeElement &&
                      u(h.activeElement).is(t.formElements) &&
                      h.activeElement !== n[0] &&
            ...
            if (
              ...
              if (
                !(
                  ...
                  Math.sqrt(Math.pow(l, 2) + Math.pow(d, 2)) <
                    this.params.threshold
                )
              ) {
                var c;
                if ('undefined' === typeof t.isScrolling)
                  ...
                  (this.isVertical() && s.currentX === s.startX)
                    ...
                    : l * l + d * d >= 25 &&
                      ((c =
                        (180 * Math.atan2(Math.abs(d), Math.abs(l))) / Math.PI),
      ...
      var O = {
                ...
                if (g.touch) {
                  ...
                  i.addEventListener(t.start, this.onTouchStart, n),
                    i.addEventListener(
                      t.move,
                      this.onTouchMove,
                      g.passiveListener ? { passive: !1, capture: a } : a
                    ),
        ...
        N = (function(e) {
          function t() {
            ...
            c.useModulesParams(p),
              (c.params = m.extend({}, p, A, r)),
              (c.originalParams = m.extend({}, c.params)),
              (c.passedParams = m.extend({}, r)),
              (c.$ = u);
            var f,
              v = u(c.params.el);
            if (!(i = v[0])) return Object(s.a)(e, void 0);
            if (v.length > 1) {
              var b = [];
              return (
                v.each(function(e, i) {
                  var s = m.extend({}, r, { el: i });
                  b.push(new t(s));
                }),
                Object(s.a)(e, b)
              );
            ...
            return (
              ...
              i && i.shadowRoot && i.shadowRoot.querySelector
                ? ((f = u(
                    i.shadowRoot.querySelector(
                      '.'.concat(c.params.wrapperClass)
                    )
                  )).children = function(e) {
                    return v.children(e);
                  })
              ...
              m.extend(c, {
                ...
                rtl:
                  'rtl' === i.dir.toLowerCase() || 'rtl' === v.css('direction'),
                rtlTranslate:
                ...
                touchEvents: (function() {
                  ...
                  return (
                    ...
                    g.touch || !c.params.simulateTouch
                      ? c.touchEventsTouch
                      : c.touchEventsDesktop
                  );
                })(),
        ...
        H = { name: 'device', proto: { device: M }, static: { device: M } },
        G = { name: 'support', proto: { support: g }, static: { support: g } },
        B = {
        ...
        V = { name: 'browser', proto: { browser: B }, static: { browser: B } },
        X = {
          name: 'resize',
          create: function() {
            var e = this;
        ...
        q = {
          ...
          enable: function() {
            this.keyboard.enabled ||
              (u(h).on('keydown', this.keyboard.handle),
              (this.keyboard.enabled = !0));
          },
          disable: function() {
            this.keyboard.enabled &&
              (u(h).off('keydown', this.keyboard.handle),
      ...
      var _ = {
              ...
              : (function() {
                  ...
                  return (
                    !e &&
                      ...
                      (e = h.implementation.hasFeature('Events.wheel', '3.0')),
                    e
                  );
                })()
              ? 'wheel'
          ...
          init: function() {
            if (this.params.scrollbar.el) {
              ...
              0 === a.length &&
                ...
                s.append(a)),
                m.extend(e, { $el: s, el: s[0], $dragEl: a, dragEl: a[0] }),
        ...
        Z = {
          setTransform: function(e, t) {
            ...
            if (
              ...
              (r =
                r.indexOf('%') >= 0
                  ? ''.concat(parseInt(r, 10) * t * a, '%')
                  : ''.concat(r * t * a, 'px')),
              (o =
                o.indexOf('%') >= 0
                  ? ''.concat(parseInt(o, 10) * t, '%')
                  : ''.concat(o * t, 'px')),
          ...
          in: function(e) {
            ...
            (w.$slideEl ||
              ...
              (w.$imageWrapEl = w.$imageEl.parent(
                '.'.concat(y.containerClass)
              ))),
            w.$imageEl && 0 !== w.$imageEl.length) &&
              (w.$slideEl.addClass(''.concat(y.zoomedSlideClass)),
              ...
              if (o > 1 || (r.loadPrevNextAmount && r.loadPrevNextAmount > 1)) {
                for (
                  var c = r.loadPrevNextAmount,
                    p = o,
                    f = Math.min(a + p + Math.max(c, p), s.length),
          ...
          setTranslate: function(e, t) {
            ...
            if (Array.isArray(n))
              for (var o = 0; o < n.length; o += 1)
                n[o] !== t && n[o] instanceof N && r(n[o]);
            else n instanceof N && t !== n && r(n);
          },
          setTransition: function(e, t) {
            var i,
              s = this,
            ...
            if (Array.isArray(a))
              for (i = 0; i < a.length; i += 1)
                a[i] !== t && a[i] instanceof N && n(a[i]);
            else a instanceof N && t !== a && n(a);
          },
        },
        ie = {
        ...
        se = {
          ...
          setHistory: function(e, t) {
            if (this.history.initialized && this.params.history.enabled) {
              ...
              c.location.pathname.includes(e) ||
                (s = ''.concat(e, '/').concat(s));
              var a = c.history.state;
              (a && a.value === s) ||
                (this.params.history.replaceState
                  ? c.history.replaceState({ value: s }, null, s)
                  : c.history.pushState({ value: s }, null, s));
            }
          },
          slugify: function(e) {
            return e
          ...
          init: function() {
            if (
              ...
              this.params.hashNavigation.watchState &&
                u(c).on('hashchange', this.hashNavigation.onHashCange);
            }
          },
          destroy: function() {
            this.params.hashNavigation.watchState &&
              u(c).off('hashchange', this.hashNavigation.onHashCange);
          },
        },
        ne = {
          run: function() {
            ...
            l.shadow &&
              (d
                ? (0 === (e = i.find('.swiper-cube-shadow')).length &&
                    ((e = u('<div class="swiper-cube-shadow"></div>')),
                    i.append(e)),
              ...
              if (d)
                ...
                e.transform(
                  'scale3d('
                    ...
                    .concat(n / 2 + z, 'px, ')
                    .concat(-n / 2 / k, 'px) rotateX(-90deg)')
                );
              }
            var $ = B.isSafari || B.isUiWebView ? -o / 2 : 0;
            i.transform(
              'translate3d(0px,0,'
                .concat($, 'px) rotateX(')
        ...
        de = {
          setTranslate: function() {
            ...
            (g.pointerEvents || g.prefixedPointerEvents) &&
              (s[0].style.perspectiveOrigin = ''.concat(l, 'px 50%'));
          },
          setTransition: function(e) {
            this.slides
              .transition(e)
            ...
            create: function() {
              m.extend(this, {
                hashNavigation: {
                  ...
                  setHash: ae.setHash.bind(this),
                  onHashCange: ae.onHashCange.bind(this),
                },
              });
            },
            on: {
...
//# sourceMappingURL=80.6aae7324.chunk.js.map
